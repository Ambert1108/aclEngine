...
int main(int argc, char* argv[])
{
  ...
  int dirTailIndex = image_path.find("_");
  std::string outfile_dir = image_path.substr(0, dirTailIndex);
  std::string outfile_path = outfile_dir + "_jpege_" + std::to_string(g_inputWidth) 
    + "_" + std::to_string(g_inputHeight) + ".jpg";
